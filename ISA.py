...
def main():
    ...
    description = 'Compilator that translates a given code and saves it into a .txt or .bin file.')
    ...
    write_to(new_file, binary, ftype)
